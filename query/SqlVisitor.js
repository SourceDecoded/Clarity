...
define(["require", "exports", "ExpressionVisitor"], function (require, exports, ExpressionVisitor) {
    ...
    var SqlVisitor = (function (_super) {
        __extends(SqlVisitor, _super);
        function SqlVisitor(tableName, model) {
            _super.call(this);
            this.model = model;
        ...
        SqlVisitor.prototype.isNotIn = function (property, array) {
            ...
            var self = this;
            return "(" + array.map(function (value) {
                return _this.notEqualTo(property, value);
            }).join(" AND ") + ")";
        };
        ;
        ...
        SqlVisitor.prototype.guid = function (expression) {
