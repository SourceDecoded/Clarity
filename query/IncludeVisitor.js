...
define(["require", "exports", "../async/Future", "./ExpressionVisitor", "../collections/Hashmap", "./Queryable"], function (require, exports, Future, ExpressionVisitor, Hashmap, Queryable) {
    var emptyFuture = Future.fromResult(null);
    ...
    var IncludeVisitor = (function (_super) {
        __extends(IncludeVisitor, _super);
        function IncludeVisitor(Type, entities, service, parameters) {
            _super.call(this);
