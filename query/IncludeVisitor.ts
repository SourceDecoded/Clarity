...
class IncludeVisitor extends ExpressionVisitor {
    _entities: any[];
    _parameters: any;
    _edm: any;
    _model: any;
    ...
    constructor(Type, entities, service, parameters) {
        super();
    ...
    queryable(properties, expression) {
        var entities = this._entities;
    ...
    propertyAccess(properties, property) {
