...
exports.Enum = Enum;
class EnumFlag extends Enum {
}
exports.EnumFlag = EnumFlag;
class DateTimeOffset extends Date {
}
...
class Edm {
    ...
    ;
    getManyToManyAsMappingRelationships(mappingEntity) {
    ...
    ;
    getSourceAndTargetsModel(relationship) {
    ...
    ;
    addPrimaryKeyRelationship(model, relationship) {
        model.properties[relationship.hasKey].primaryKeyRelationships.push(relationship);
    }
    ;
    addForeignKeyRelationship(model, relationship) {
    ...
    ;
    removePrimaryKeyRelationship(model, relationship) {
        var models = this.getSourceAndTargetsModel(relationship);
    ...
    ;
    removeForeignKeyRelationship(model, relationship) {
    ...
    ;
    _getPrimaryKeyProperties(model) {
