...
import easings = require("./easings");
import delayAsync = require("../../async/delayAsync");
...
class Animation {
    ...
    _beginningValues;
    _startTime;
    _currentRequestAnimationFrameId;
    _currentState;
    iterations;
    repeat;
    repeatDirection;
    ...
    static REPEAT_DEFAULT = 0;
    static REPEAT_ALTERATE = 1;
