/*
    All animations use the same state manager. The flyweight pattern saves us on memory.
*/
"use strict";
...
var notifyTickForward = function (animation, lastProgress, progress) {
    var lastPercentage = Math.floor(lastProgress * 100);
...
module.exports = animationStateManager;
