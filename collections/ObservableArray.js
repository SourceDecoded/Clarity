define(["require", "exports", "../util/Observer"], function (require, exports, Observer) {
    var emptyFn = function () { };
    var defaultFunction = function (itemA, itemB) {
        return itemA === itemB;
    };
    ...
    var ObservableArray = function (Type) {
        var self = this;
        ...
        self.concat = function () {
            ...
            ObservableArray.apply(newArray);
            return newArray;
        };
        self.sync = function (newSet, isEqualToFunction) {
            var notInNew = [];
            var notInThis = [];
            var thisArr = this;
            isEqualToFunction = typeof isEqualToFunction === "function" ? isEqualToFunction : defaultFunction;
            thisArr.forEach(function (item) {
                if (newSet.indexOfByFunction(function (subItem) {
                    return isEqualToFunction(subItem, item);
                }) === -1) {
                    notInNew.push(item);
                }
            });
            newSet.forEach(function (item) {
                if (thisArr.indexOfByFunction(function (subItem) {
                    return isEqualToFunction(subItem, item);
                }) === -1) {
                    notInThis.push(item);
                }
